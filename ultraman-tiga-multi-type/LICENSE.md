# 素材使用声明 / Asset Usage Notice

- 投稿者 / Contributor: YaKun9
- 宠物 / Pet: 迪迦奥特曼 / Ultraman Tiga
- 来源 / Based on: 《迪迦奥特曼》复合型、空中型与强力型 / Ultraman Tiga Multi Type, Sky Type, and Power Type from *Ultraman Tiga*
...
The contributor has authorized the codex-pets repository to include the assets in this directory and, to the extent permitted by applicable law and relevant rights-holder policies, allow users to download, use, copy, modify, and share them for non-commercial purposes, including cloning or forking the complete repository, submitting Pull Requests, and installing them in a personal Codex environment.
